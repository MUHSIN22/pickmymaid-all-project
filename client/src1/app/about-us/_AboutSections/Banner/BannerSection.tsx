  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5 items-center md:items-start justify-center">
        <h1 className="heading-primary-small text-primary-300">About Us</h1>
        <p className="max-w-[60vw] text-center md:text-left text-[#3F1010] ">
          Find the perfect maids and nannies you want to hire. We will make it
          easier. Our commitment is to provide reliable, efficient, and
          personalized service, ensuring the safety and satisfaction of both
